        ...
        <div className="container">
            ...
            <div className="collapse navbar-collapse navbar-right">
                <ul className="nav navbar-nav">
                    <li><Link className="btn btn-github btn-stacked btn-stroke" to="/dashboard">Dashboard</Link></li>
                    <li><Link className="btn btn-github btn-stacked btn-stroke" to="/Profile">Profile</Link></li>
                </ul>
                <ul className="nav navbar-nav navbar-right">
                  <li><Link className="btn btn-github btn-stacked btn-stroke" to="/signout">Sign Out</Link></li>
                </ul>
                {/*<ul className="nav navbar-nav navbar-right">
