...
class Form_Instagram extends Component {
  ...
  handleAuth(){
    ...
    window.open(`https://api.instagram.com/oauth/authorize/?client_id=${config.Instagram.id_key}&redirect_uri=${config.Instagram.redirect_uri}&response_type=code&state=${user_id.sub}&scope=basic+public_content`, "Instagram Authorization", "titlebar=yes, width=500, height=450");
  }
